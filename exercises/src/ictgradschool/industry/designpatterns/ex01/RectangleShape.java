...
public class RectangleShape extends Shape {
	/**
	 * Default constructor that creates a ictgradschool.industry.designpatterns.ex01.RectangleShape instance whose instance
	...
	/**
	 * Creates a ictgradschool.industry.designpatterns.ex01.RectangleShape instance with specified values for instance
	 * variables.
	 * @param x x position.
	 * @param y y position.
